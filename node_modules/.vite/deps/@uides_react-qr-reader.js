...
// node_modules/@uides/react-qr-reader/lib/errors.js
var require_errors = __commonJS({
  "node_modules/@uides/react-qr-reader/lib/errors.js"(exports, module) {
    "use strict";
...
// node_modules/@uides/react-qr-reader/lib/getDeviceId.js
var require_getDeviceId = __commonJS({
  "node_modules/@uides/react-qr-reader/lib/getDeviceId.js"(exports, module) {
    "use strict";
...
// node_modules/@uides/react-qr-reader/lib/havePropsChanged.js
var require_havePropsChanged = __commonJS({
  "node_modules/@uides/react-qr-reader/lib/havePropsChanged.js"(exports, module) {
    "use strict";
...
// node_modules/@uides/react-qr-reader/lib/createBlob.js
var require_createBlob = __commonJS({
  "node_modules/@uides/react-qr-reader/lib/createBlob.js"(exports, module) {
    "use strict";
...
function shimGetDisplayMedia(window2, getSourceId) {
  ...
  window2.navigator.mediaDevices.getDisplayMedia = function(constraints) {
...
function shimOnTrack(window2) {
  if (typeof window2 === "object" && window2.RTCPeerConnection && !("ontrack" in window2.RTCPeerConnection.prototype)) {
    ...
    window2.RTCPeerConnection.prototype.setRemoteDescription = function() {
...
function shimGetSendersWithDtmf(window2) {
  if (typeof window2 === "object" && window2.RTCPeerConnection && !("getSenders" in window2.RTCPeerConnection.prototype) && "createDTMFSender" in window2.RTCPeerConnection.prototype) {
    ...
    if (!window2.RTCPeerConnection.prototype.getSenders) {
      window2.RTCPeerConnection.prototype.getSenders = function() {
        this._senders = this._senders || [];
        return this._senders.slice();
      };
      const origAddTrack = window2.RTCPeerConnection.prototype.addTrack;
      window2.RTCPeerConnection.prototype.addTrack = function(track, stream) {
      ...
      window2.RTCPeerConnection.prototype.removeTrack = function(sender) {
    ...
    window2.RTCPeerConnection.prototype.addStream = function(stream) {
      this._senders = this._senders || [];
    ...
    window2.RTCPeerConnection.prototype.removeStream = function(stream) {
      this._senders = this._senders || [];
...
function shimSenderReceiverGetStats(window2) {
  ...
  if (!("getStats" in window2.RTCRtpSender.prototype)) {
    ...
    const origAddTrack = window2.RTCPeerConnection.prototype.addTrack;
    if (origAddTrack) {
      window2.RTCPeerConnection.prototype.addTrack = function() {
        const sender = origAddTrack.apply(this, arguments);
        sender._pc = this;
        return sender;
      };
    }
    window2.RTCRtpSender.prototype.getStats = function() {
      const sender = this;
  ...
  if (!("getStats" in window2.RTCRtpReceiver.prototype)) {
    ...
    if (origGetReceivers) {
      window2.RTCPeerConnection.prototype.getReceivers = function() {
    ...
    window2.RTCRtpReceiver.prototype.getStats = function() {
      const receiver = this;
  ...
  window2.RTCPeerConnection.prototype.getStats = function() {
...
function shimAddTrackRemoveTrackWithNative(window2) {
  window2.RTCPeerConnection.prototype.getLocalStreams = function() {
...
function shimAddTrackRemoveTrack(window2) {
  ...
  ["createOffer", "createAnswer"].forEach(function(method) {
    ...
    window2.RTCPeerConnection.prototype[method] = function() {
  ...
  window2.RTCPeerConnection.prototype.setLocalDescription = function() {
...
function shimPeerConnection(window2) {
  ...
  const origGetStats = window2.RTCPeerConnection.prototype.getStats;
  window2.RTCPeerConnection.prototype.getStats = function(selector, successCallback, errorCallback) {
    const args = arguments;
  ...
  window2.RTCPeerConnection.prototype.addIceCandidate = function() {
    if (!arguments[0]) {
      if (arguments[1]) {
...
function shimPeerConnection2(window2) {
  ...
  if (window2.RTCIceGatherer) {
    if (!window2.RTCIceCandidate) {
      window2.RTCIceCandidate = function(args) {
        return args;
      };
    }
    if (!window2.RTCSessionDescription) {
      window2.RTCSessionDescription = function(args) {
        return args;
      };
    }
  ...
  window2.RTCPeerConnection = function(config) {
...
function shimPeerConnection3(window2) {
  ...
  window2.RTCPeerConnection.prototype.getStats = function(selector, onSucc, onErr) {
...
function shimRemoteStreamsAPI(window2) {
  ...
  if (!("getRemoteStreams" in window2.RTCPeerConnection.prototype)) {
    window2.RTCPeerConnection.prototype.getRemoteStreams = function() {
...
function shimGetUserMedia4(window2) {
  ...
  if (!navigator2.getUserMedia && navigator2.mediaDevices && navigator2.mediaDevices.getUserMedia) {
    navigator2.getUserMedia = (function(constraints, cb, errcb) {
...
function shimRTCIceServerUrls(window2) {
  ...
  window2.RTCPeerConnection = function(pcConfig, pcConstraints) {
...
function shimTrackEventTransceiver(window2) {
  if (typeof window2 === "object" && window2.RTCPeerConnection && "receiver" in window2.RTCTrackEvent.prototype && // can't check 'transceiver' in window.RTCTrackEvent.prototype, as it is
  // defined for some reason even when window.RTCTransceiver is not.
  !window2.RTCTransceiver) {
    Object.defineProperty(window2.RTCTrackEvent.prototype, "transceiver", {
      get() {
        return { receiver: this.receiver };
      }
...
function shimCreateOfferLegacy(window2) {
  ...
  window2.RTCPeerConnection.prototype.createOffer = function(offerOptions) {
    if (offerOptions) {
...
function shimMaxMessageSize(window2) {
  if (window2.RTCSctpTransport || !window2.RTCPeerConnection) {
    return;
  }
  const browserDetails = detectBrowser(window2);
...
function shimSendThrowTypeError(window2) {
  ...
  window2.RTCPeerConnection.prototype.createDataChannel = function() {
...
function removeAllowExtmapMixed(window2) {
  ...
  window2.RTCPeerConnection.prototype.setRemoteDescription = function(desc) {
...
var init_adapter_core = __esm({
  "node_modules/webrtc-adapter/src/js/adapter_core.js"() {
    ...
    adapter = adapterFactory({ window });
    adapter_core_default = adapter;
  }
});

// node_modules/@uides/react-qr-reader/lib/index.js
var require_lib = __commonJS({
  "node_modules/@uides/react-qr-reader/lib/index.js"(exports, module) {
...
//# sourceMappingURL=@uides_react-qr-reader.js.map
